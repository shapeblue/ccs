...
mkdir -p ${RPM_BUILD_ROOT}%{_datadir}/cloudstack-management/webapp/WEB-INF/lib
...
cp -r target/cloud-plugin-shapeblue-ccs-%{_maventag}.jar ${RPM_BUILD_ROOT}%{_datadir}/cloudstack-management/webapp/WEB-INF/lib/
...
cp target/dependency/flyway-core-*.jar ${RPM_BUILD_ROOT}%{_datadir}/cloudstack-management/webapp/WEB-INF/lib/
