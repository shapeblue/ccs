...
import com.cloud.containercluster.ContainerClusterManager;
...
@APICommand(name = ListContainerClusterCACertCmd.APINAME,
...
public class ListContainerClusterCACertCmd extends BaseCmd {

    public static final String APINAME = "listContainerClusterCACert";
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException, ResourceAllocationException, NetworkRuleConflictException {
        final KeystoreVO rootCA = keystoreDao.findByName(ContainerClusterManager.CCS_ROOTCA_KEYPAIR);
