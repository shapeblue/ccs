...
@APICommand(name = "createContainerCluster", description = "Creates and cluster of VM's for launching containers.", responseObject = ContainerClusterResponse.class, responseView = ResponseView.Restricted, entityType = {ContainerCluster.class},
...
public class CreateContainerClusterCmd extends BaseAsyncCreateCustomIdCmd {
    ...
    @Parameter(name = ApiConstants.DESCRIPTION, type = CommandType.STRING, description = "description for the cluster")
    private String description;

    @Parameter(name = ApiConstants.ZONE_ID, type = CommandType.UUID, entityType = ZoneResponse.class, required = true, description = "availability zone for the cluster")
    private Long zoneId;
    ...
    @Parameter(name = ApiConstants.PROJECT_ID, type = CommandType.UUID, entityType = ProjectResponse.class, description = "Deploy cluster for the project")
    private Long projectId;

    @Parameter(name = ApiConstants.NETWORK_ID, type = CommandType.UUID, entityType = NetworkResponse.class, description = "Network in which container cluster is to be launched")
    private Long networkId;

    @Parameter(name = ApiConstants.SSH_KEYPAIR, type = CommandType.STRING, description = "name of the ssh key pair used to login to the virtual machines")
    private String sshKeyPairName;

    @Parameter(name=ApiConstants.CONTAINER_CLUSTER_SIZE, type = CommandType.LONG, required = true, description = "number of container cluster nodes")
    ...
    public String getEventType() {
        return EventTypes.EVENT_CLUSTER_CREATE;
    }
    ...
    public String getCreateEventDescription() {
        return "creating VM cluster";
    }

    @Override
    public String getEventDescription() {
        return "creating VM cluster. Cluster Id: " + getEntityId();
    }

    @Override
    public ApiCommandJobType getInstanceType() {
        return ApiCommandJobType.Cluster;
    }
    ...
    public void execute() {
        ...
        if (containerCluster != null) {
            ContainerClusterResponse response = _responseGenerator.createContainerClusterResponse(containerCluster);
