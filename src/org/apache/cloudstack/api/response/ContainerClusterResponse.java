...
@EntityReference(value = {ContainerCluster.class})
public class ContainerClusterResponse extends BaseResponse implements ControlledEntityResponse {
    ...
    public ContainerClusterResponse() {
