...
public class ContainerClusterManagerImplTest {
    ...
    @Spy
    ContainerClusterManagerImpl ccManager = new ContainerClusterManagerImpl();

    @Mock
    ContainerClusterDao containerClusterDao;
    @Mock
    ContainerClusterVmMapDao clusterVmMapDao;
    @Mock
    ContainerClusterDetailsDao containerClusterDetailsDao;
    @Mock
    ...
    @Mock
    public ContainerClusterVmMapDao containerClusterVmMapDao;
    @Mock
    ...
    public void setUp() {
        ...
        ccManager._containerClusterDao = containerClusterDao;
        ccManager._clusterVmMapDao = clusterVmMapDao;
        ccManager._containerClusterDetailsDao = containerClusterDetailsDao;
